...
public class ZooClub implements Serializable {
    ...
    void writeText() {
        try (FileWriter writer = new FileWriter("D:\\консоль.txt", true)) {
    ...
    void readTextFile(){
        try(FileReader reader = new FileReader("D:\\консоль.txt")){
            int c;
    ...
    void subtractFromNotepad() throws IOException, ClassNotFoundException {
        FileInputStream fis = new FileInputStream("D:\\ text.txt");
        ObjectInputStream ois = new ObjectInputStream(fis);
        ZooClub zc = (ZooClub) ois.readObject();
        System.out.println("Version - " + zc.version);
    }
}
